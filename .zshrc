...
export MU_KEY="erBVIQKkV6VBA8bz6gqk"
if [ "$SHELL" = "/bin/bash" ]; then
    export SHELL=$HOME/aswerdlo/bin/zsh
    exec $SHELL
else
    ...
    export AZURE_OPENAI_KEY=3945c37b7ec549d08736563460310eb8
    export AZURE_OPENAI_ENDPOINT=https://katef-gpt-4.openai.azure.com/
...
# export PATH="/home/mprabhud/miniconda3/bin:$PATH"  # commented out by conda initialize
        elif [[ -v GROGU_NODE ]]; then
# export PATH="/grogu/user/mprabhud/miniconda3/bin:$PATH"  # commented out by conda initialize
        fi
    fi
...
# . "/home/mprabhud/miniconda3/etc/profile.d/conda.sh"  # commented out by conda initialize
          else
# export PATH="/home/mprabhud/miniconda3/bin:$PATH"  # commented out by conda initialize
          fi
      fi
    ...
    export DIFFUSION_DATA_DIR="/grogu/user/mprabhud/data/diffusion/"
    export HF_HUB_DATASETS_TOKEN="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"
    export HF_DATASETS_CACHE="/grogu/user/mprabhud/aswerdlo/huggingface/datasets"
    export MDLM_DATA_DIR="/grogu/user/mprabhud/data/diffusion"
    export MDLM_LIB_DIR="/home/mprabhud/aswerdlo/repos/lib"
    export MDLM_DIR="/home/mprabhud/aswerdlo/repos/mdlm"    
    # https://www.calmar.ws/vim/256-xterm-24bit-rgb-color-chart.htmlx
    stty sane
    export MUJOCO_GL="egl"
    micromamba activate alignprop
