...
def main(partition: str):
    ...
    def run_ssh_command(node):
        ...
        ssh_command = f"ssh -o StrictHostKeyChecking=no -f {node} '/bin/sh /home/mprabhud/dotfiles/scripts/matrix/save_ids_node.sh' --norc --noprofile"
        ...
        if result.returncode == 0:
            ...
            return f"Error on {node}" # {result.stderr}
...
# PARTITION='all' sb --quick 'sleep 6000000'
